 ...
 * @author rutfern
 *
 * Versión del Ejercicio1 con Listner la propia ventana
 *
 */
public class Ejercicio1_Listener extends javax.swing.JFrame implements FocusListener {
    ...
    private void crearComponentes() {
        ...
        etiqueta = new JLabel();
        //Alineación del contenido a lo largo del eje x
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ejercicio1_Listener.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ejercicio1_Listener().setVisible(true);
            }
        });
    }
