 ...
 * @author rutfern
 *
 * Versión del Ejercicio1 con Listner otro objeto
 *
 */
public class Ejercicio11_Listener extends javax.swing.JFrame {
    ...
    private void crearComponentes() {
        ...
        caja1.addFocusListener(l);
        caja2.addFocusListener(l);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ejercicio11_Listener.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ejercicio11_Listener().setVisible(true);
            }
        });
    }
